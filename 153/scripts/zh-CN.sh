...
echo "about-addressbook-column-header-a11y-categories2 = 分类" >> localization/zh-CN/messenger/addressbook/aboutAddressBook.ftl
...
echo "search-add-group-button ="     >> localization/zh-CN/messenger/searchWidgets.ftl
echo "  .label = +( )"               >> localization/zh-CN/messenger/searchWidgets.ftl
echo "  .tooltiptext = 增加一个新的组" >> localization/zh-CN/messenger/searchWidgets.ftl

echo "search-attrib-expires = Expires" >> localization/zh-CN/messenger/searchWidgets.ftl
echo "search-attrib-categories = 分类" >> localization/zh-CN/messenger/searchWidgets.ftl

# Strings for searching all mail accounts:
# search-all-mail-accounts =
#   .label = Search all mail accounts
#   .accesskey = m
echo "search-all-mail-accounts =" >> localization/zh-CN/messenger/searchDialog.ftl
echo "  .label = 搜索所有邮件账户"   >> localization/zh-CN/messenger/searchDialog.ftl
echo "  .accesskey = m"           >> localization/zh-CN/messenger/searchDialog.ftl

# New in 153:

echo "recent-sort-order-combined ="                                                        >> localization/zh-CN/messenger/preferences/preferences.ftl
echo "  .label = { recent-sort-order-mru.label } + { recent-sort-order-alphabetic.label }" >> localization/zh-CN/messenger/preferences/preferences.ftl
...
#   .accesskey = S
# echo "minimize-to-tray-label ="                        >> localization/zh-CN/messenger/preferences/preferences.ftl
# echo "  .label = 最小化 { -brand-short-name } 到系统托盘" >> localization/zh-CN/messenger/preferences/preferences.ftl
# echo "  .accesskey = m"                                >> localization/zh-CN/messenger/preferences/preferences.ftl
echo "close-to-tray-label ="                          >> localization/zh-CN/messenger/preferences/preferences.ftl
echo "  .label = 关闭 { -brand-short-name } 到系统托盘" >> localization/zh-CN/messenger/preferences/preferences.ftl
echo "  .accesskey = c"                               >> localization/zh-CN/messenger/preferences/preferences.ftl
