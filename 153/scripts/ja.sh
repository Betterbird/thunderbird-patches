...
echo "about-addressbook-column-header-a11y-categories2 = カテゴリ" >> localization/ja/messenger/addressbook/aboutAddressBook.ftl
...
echo "search-add-group-button ="          >> localization/ja/messenger/searchWidgets.ftl
echo "  .label = +( )"                    >> localization/ja/messenger/searchWidgets.ftl
echo "  .tooltiptext = 新しいグループを追加します" >> localization/ja/messenger/searchWidgets.ftl

echo "search-attrib-expires = Expires"  >> localization/ja/messenger/searchWidgets.ftl
echo "search-attrib-categories = カテゴリ" >> localization/ja/messenger/searchWidgets.ftl

# Strings for searching all mail accounts:
# search-all-mail-accounts =
#   .label = Search all mail accounts
#   .accesskey = m
echo "search-all-mail-accounts ="      >> localization/ja/messenger/searchDialog.ftl
echo "  .label = すべてのメールアカウントを検索" >> localization/ja/messenger/searchDialog.ftl
echo "  .accesskey = m"                >> localization/ja/messenger/searchDialog.ftl
...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                >> localization/ja/messenger/preferences/preferences.ftl
# echo "  .label = 最小化した { -brand-short-name } をタスクトレイにしまう" >> localization/ja/messenger/preferences/preferences.ftl
# echo "  .accesskey = m"                                        >> localization/ja/messenger/preferences/preferences.ftl
