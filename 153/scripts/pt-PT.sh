...
echo "movemailCantCreateLock=Não foi possível criar o ficheiro de bloqueio %S. Para mover o correio, tem de criar os ficheiros no diretório de spool. Em muitos sistemas, a melhor forma de o fazer é aplicar o modo 01777 no diretório." >> chrome/pt-PT/locale/pt-PT/messenger/localMsgs.properties
...
echo "movemailCantParseSpool=Não foi possível processar o ficheiro de spool %S. O ficheiro pode estar danificado ou ser inválido." >> chrome/pt-PT/locale/pt-PT/messenger/localMsgs.properties
...
echo "    .accesskey = a"               >> localization/pt-PT/messenger/menubar.ftl
...
echo "    .accesskey = E"               >> localization/pt-PT/messenger/menubar.ftl
...
echo "    .label = Restaurar tópico original" >> localization/pt-PT/messenger/messenger.ftl
...
echo "about-addressbook-column-header-a11y-categories2 = Categorias" >> localization/pt-PT/messenger/addressbook/aboutAddressBook.ftl
...
echo "search-add-group-button ="                >> localization/pt-PT/messenger/searchWidgets.ftl
echo "  .label = +( )"                          >> localization/pt-PT/messenger/searchWidgets.ftl
echo "  .tooltiptext = Adicionar um novo grupo" >> localization/pt-PT/messenger/searchWidgets.ftl

echo "search-attrib-expires = Expires"       >> localization/pt-PT/messenger/searchWidgets.ftl
echo "search-attrib-categories = Categorias" >> localization/pt-PT/messenger/searchWidgets.ftl

# Strings for searching all mail accounts:
# search-all-mail-accounts =
#   .label = Search all mail accounts
#   .accesskey = m
echo "search-all-mail-accounts ="                        >> localization/pt-PT/messenger/searchDialog.ftl
echo "  .label = Procurar em todas as contas de correio" >> localization/pt-PT/messenger/searchDialog.ftl
echo "  .accesskey = c"                                  >> localization/pt-PT/messenger/searchDialog.ftl

# New in 153:

echo "recent-sort-order-combined ="                                                        >> localization/pt-PT/messenger/preferences/preferences.ftl
echo "  .label = { recent-sort-order-mru.label } + { recent-sort-order-alphabetic.label }" >> localization/pt-PT/messenger/preferences/preferences.ftl
...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                                         >> localization/pt-PT/messenger/preferences/preferences.ftl
# echo "  .label = Quando o { -brand-short-name } for minimizado, movê-lo para a bandeja" >> localization/pt-PT/messenger/preferences/preferences.ftl
# echo "  .accesskey = m"                                                                 >> localization/pt-PT/messenger/preferences/preferences.ftl
echo "close-to-tray-label ="                                                         >> localization/pt-PT/messenger/preferences/preferences.ftl
echo "  .label = Quando o { -brand-short-name } for fechado, movê-lo para a bandeja" >> localization/pt-PT/messenger/preferences/preferences.ftl
echo "  .accesskey = f"                                                              >> localization/pt-PT/messenger/preferences/preferences.ftl
