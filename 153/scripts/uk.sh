...
echo "about-addressbook-column-header-a11y-categories2 = Категорії" >> localization/uk/messenger/addressbook/aboutAddressBook.ftl
...
echo "search-add-group-button ="          >> localization/uk/messenger/searchWidgets.ftl
echo "  .label = +( )"                    >> localization/uk/messenger/searchWidgets.ftl
echo "  .tooltiptext = Додати нову групу" >> localization/uk/messenger/searchWidgets.ftl

echo "search-attrib-expires = Expires"      >> localization/uk/messenger/searchWidgets.ftl
echo "search-attrib-categories = Категорії" >> localization/uk/messenger/searchWidgets.ftl

# Strings for searching all mail accounts:
# search-all-mail-accounts =
#   .label = Search all mail accounts
#   .accesskey = m
echo "search-all-mail-accounts ="                         >> localization/uk/messenger/searchDialog.ftl
echo "  .label = Пошук у всіх поштових облікових записах" >> localization/uk/messenger/searchDialog.ftl
echo "  .accesskey = п"                                   >> localization/uk/messenger/searchDialog.ftl
...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                      >> localization/uk/messenger/preferences/preferences.ftl
# echo "  .label = Згортати { -brand-short-name } в область сповіщень" >> localization/uk/messenger/preferences/preferences.ftl
# echo "  .accesskey = З"                                              >> localization/uk/messenger/preferences/preferences.ftl
...
echo "system-tray-menuitem-quit = Вийти з { -brand-full-name }" >> localization/uk/messenger/menubar.ftl
