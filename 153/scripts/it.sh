...
echo "about-addressbook-column-header-a11y-categories2 = Categorie" >> localization/it/messenger/addressbook/aboutAddressBook.ftl
...
echo "search-add-group-button ="              >> localization/it/messenger/searchWidgets.ftl
echo "  .label = +( )"                        >> localization/it/messenger/searchWidgets.ftl
echo "  .tooltiptext = Aggiungi nuovo gruppo" >> localization/it/messenger/searchWidgets.ftl

echo "search-attrib-expires = Expires"      >> localization/it/messenger/searchWidgets.ftl
echo "search-attrib-categories = Categorie" >> localization/it/messenger/searchWidgets.ftl

# Strings for searching all mail accounts:
# search-all-mail-accounts =
#   .label = Search all mail accounts
#   .accesskey = m
echo "search-all-mail-accounts ="                     >> localization/it/messenger/searchDialog.ftl
echo "  .label = Cerca in tutti gli account di posta" >> localization/it/messenger/searchDialog.ftl
echo "  .accesskey = s"                               >> localization/it/messenger/searchDialog.ftl

# New in 153:

echo "recent-sort-order-combined ="                                                        >> localization/it/messenger/preferences/preferences.ftl
echo "  .label = { recent-sort-order-mru.label } + { recent-sort-order-alphabetic.label }" >> localization/it/messenger/preferences/preferences.ftl
...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                                                  >> localization/it/messenger/preferences/preferences.ftl
# echo "  .label = Quando { -brand-short-name } è ridotto a icona, spostalo nell'area di notifica" >> localization/it/messenger/preferences/preferences.ftl
# echo "  .accesskey = n"                                                                          >> localization/it/messenger/preferences/preferences.ftl
echo "close-to-tray-label ="                                                            >> localization/it/messenger/preferences/preferences.ftl
echo "  .label = Quando { -brand-short-name } è chiuso, spostalo nell’area di notifica" >> localization/it/messenger/preferences/preferences.ftl
echo "  .accesskey = c"                                                                 >> localization/it/messenger/preferences/preferences.ftl
