...
echo "about-addressbook-column-header-a11y-categories2 = Категории" >> localization/ru/messenger/addressbook/aboutAddressBook.ftl
...
echo "search-add-group-button ="              >> localization/ru/messenger/searchWidgets.ftl
echo "  .label = +( )"                        >> localization/ru/messenger/searchWidgets.ftl
echo "  .tooltiptext = Добавить новую группу" >> localization/ru/messenger/searchWidgets.ftl

echo "search-attrib-expires = Expires"      >> localization/ru/messenger/searchWidgets.ftl
echo "search-attrib-categories = Категории" >> localization/ru/messenger/searchWidgets.ftl

# Strings for searching all mail accounts:
# search-all-mail-accounts =
#   .label = Search all mail accounts
#   .accesskey = m
echo "search-all-mail-accounts ="                  >> localization/ru/messenger/searchDialog.ftl
echo "  .label = Поиск по всем почтовым аккаунтам" >> localization/ru/messenger/searchDialog.ftl
echo "  .accesskey = п"                            >> localization/ru/messenger/searchDialog.ftl

# New in 153:

echo "recent-sort-order-combined ="                                                        >> localization/ru/messenger/preferences/preferences.ftl
echo "  .label = { recent-sort-order-mru.label } + { recent-sort-order-alphabetic.label }" >> localization/ru/messenger/preferences/preferences.ftl
...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                                      >> localization/ru/messenger/preferences/preferences.ftl
# echo "  .label = При сворачивании перемещать { -brand-short-name } в системный трей" >> localization/ru/messenger/preferences/preferences.ftl
# echo "  .accesskey = ч"                                                              >> localization/ru/messenger/preferences/preferences.ftl
echo "close-to-tray-label ="                                                     >> localization/ru/messenger/preferences/preferences.ftl
echo "  .label = При закрытии перемещать { -brand-short-name } в системный трей" >> localization/ru/messenger/preferences/preferences.ftl
echo "  .accesskey = к"                                                          >> localization/ru/messenger/preferences/preferences.ftl
