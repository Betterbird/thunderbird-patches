...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                                              >> localization/es-ES/messenger/preferences/preferences.ftl
# echo "  .label = Cuando se minimiza { -brand-short-name }, moverlo a la bandeja del sistema" >> localization/es-ES/messenger/preferences/preferences.ftl
# echo "  .accesskey = m"                                                                      >> localization/es-ES/messenger/preferences/preferences.ftl
echo "close-to-tray-label ="                                                               >> localization/es-ES/messenger/preferences/preferences.ftl
echo "  .label = Cuando se cierra { -brand-short-name }, moverlo a la bandeja del sistema" >> localization/es-ES/messenger/preferences/preferences.ftl
echo "  .accesskey = c"                                                                    >> localization/es-ES/messenger/preferences/preferences.ftl
