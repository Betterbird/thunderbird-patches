...
#   .accesskey = S
# echo "minimize-to-tray-label ="                                                       >> localization/sv-SE/messenger/preferences/preferences.ftl
# echo "  .label = När { -brand-short-name } minimeras, flytta den till aktivitetsfält" >> localization/sv-SE/messenger/preferences/preferences.ftl
# echo "  .accesskey = m"                                                               >> localization/sv-SE/messenger/preferences/preferences.ftl
