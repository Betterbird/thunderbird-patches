...
%lecho% "calendar-event-listing-interval-all ="  >> localization\it\calendar\calendar-event-listing.ftl
%lecho% "  .label = Tutti gli eventi"            >> localization\it\calendar\calendar-event-listing.ftl
