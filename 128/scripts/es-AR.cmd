...
%lecho% "  .label = Eventos en el pasado (a partir de 1970)" >> localization\es-AR\calendar\calendar-event-listing.ftl
...
%lecho% "    .tooltiptext = Concordar con nombre para mostrar (comienza por) o apodo (es) de las libretas de direcciones" >> localization\es-AR\messenger\about3Pane.ftl
