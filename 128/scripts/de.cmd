...
%lecho% "  .label = Konto deaktiviert" >> localization\de\messenger\messenger.ftl
...
%lecho% "    .tooltiptext = Anzeigename (beginnt mit) oder Spitzname (ist) aus den Adressbüchern vergleichen" >> localization\de\messenger\about3Pane.ftl
