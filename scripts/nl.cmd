...
%lecho% "<!ENTITY hdrOpenConversationButton1.tooltip \"Conversatie voor geselecteerde bericht tonen\">" | %icv% >> chrome\nl\locale\nl\messenger\msgHdrViewOverlay.dtd
...
%lecho% "<!ENTITY contextDecryptToFolder.label \"Ontsleutelen in map\">" | %icv% >> chrome\nl\locale\nl\messenger\messenger.dtd
...
%lecho% "<!ENTITY quickFilterBar.untagged.tooltip \"Berichten zonder labels tonen\">" | %icv% >> chrome\nl\locale\nl\messenger\quickFilterBar.dtd
%lecho% "<!ENTITY quickFilterBar.tagged.tooltip \"Berichten met een of meer labels tonen. Klik met de rechtermuisknop om de selectie van individuele labels te wissen.\">" | %icv% >> chrome\nl\locale\nl\messenger\quickFilterBar.dtd

:: Original strings:
:: enable-gloda-search-encrypted-label =
::     .label = Enable search in encrypted messages (stores decrypted copy locally)
%lecho% "enable-gloda-search-encrypted-label =" >> localization\nl\messenger\preferences\preferences.ftl
%lecho% "    .label = Versleutelde berichten doorzoekbaar maken (slaat ontsleutelde kopie lokaal op)" | %icv% >> localization\nl\messenger\preferences\preferences.ftl
