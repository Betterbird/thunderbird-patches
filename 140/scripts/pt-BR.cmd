...
%lecho% "<!ENTITY storeOnUpdatedInfo.label \"Para canais de informações Atom ou JSON com a tag "'&lt;updated&gt;'". Se o editor alterar o valor, armazena o artigo em vez de tratá-lo como duplicado.\">" >> chrome\pt-BR\locale\pt-BR\messenger-newsblog\feed-subscriptions.dtd
...
%lecho% "run-filters-on-incoming-msgs ="                      >> localization\pt-BR\messenger\folderprops.ftl
%lecho% "  .label = Executar filtros nas mensagens recebidas" >> localization\pt-BR\messenger\folderprops.ftl
...
%lecho% "carddav-directory-sync-warning =" >> localization\pt-BR\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "    CardDAV: Alguns dados foram descartados pelo servidor, por favor verifique a Consola de Erros para mais detalhes" >> localization\pt-BR\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "carddav-directory-sync-failed =" >> localization\pt-BR\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "    CardDAV: Falha na sincronização com o servidor, por favor verifique a Consola de Erros para mais detalhes" >> localization\pt-BR\messenger\addressbook\abCardDAVProperties.ftl

:: Strings for bug 1972710:
:: folder-pane-context-reset-sort =
::   .label = Reset Folder Order
::   .accesskey = R
%lecho% "folder-pane-context-reset-sort ="     >> localization\pt-BR\messenger\about3Pane.ftl
%lecho% "  .label = Redefinir ordem de pastas" >> localization\pt-BR\messenger\about3Pane.ftl
%lecho% "  .accesskey = R"                     >> localization\pt-BR\messenger\about3Pane.ftl

:: Strings for searching all mail accounts:
:: search-all-mail-accounts =
::   .label = Search all mail accounts
::   .accesskey = m
%lecho% "search-all-mail-accounts ="                        >> localization\pt-BR\messenger\messenger.ftl
%lecho% "  .label = Pesquisar em todas as contas de e-mail" >> localization\pt-BR\messenger\messenger.ftl
%lecho% "  .accesskey = m"                                  >> localization\pt-BR\messenger\messenger.ftl
