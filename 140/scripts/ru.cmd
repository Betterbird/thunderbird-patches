...
%lecho% "    .label = Горизонтальный вид" >> localization\ru\messenger\menubar.ftl
...
%lecho% "<!ENTITY storeOnUpdated.label \"Сохранять обновлённые статьи\">" >> chrome\ru\locale\ru\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeOnUpdated.accesskey \"u\">"                        >> chrome\ru\locale\ru\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeOnUpdatedInfo.label \"Для лент Atom или JSON с тегом "'&lt;updated&gt;'". Если издатель изменит значение, статья будет сохранена, а не распознана как дубликат.\">" >> chrome\ru\locale\ru\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeWebPageArchive.label \"Сохранять архив веб-страницы вместе со статьёй\">" >> chrome\ru\locale\ru\messenger-newsblog\feed-subscriptions.dtd
...
%lecho% "run-filters-on-incoming-msgs ="                      >> localization\ru\messenger\folderprops.ftl
%lecho% "  .label = Запускать фильтры для входящих сообщений" >> localization\ru\messenger\folderprops.ftl
...
%lecho% "    CardDAV: Некоторые данные были отброшены сервером. Подробности можно найти в консоли ошибок." >> localization\ru\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "carddav-directory-sync-failed =" >> localization\ru\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "    CardDAV: Сбой синхронизации с сервером. Подробности можно найти в консоли ошибок." >> localization\ru\messenger\addressbook\abCardDAVProperties.ftl

:: Strings for bug 1972710:
:: folder-pane-context-reset-sort =
::   .label = Reset Folder Order
::   .accesskey = R
%lecho% "folder-pane-context-reset-sort ="  >> localization\ru\messenger\about3Pane.ftl
%lecho% "  .label = Сбросить порядок папок" >> localization\ru\messenger\about3Pane.ftl
%lecho% "  .accesskey = К"                  >> localization\ru\messenger\about3Pane.ftl

:: Strings for searching all mail accounts:
:: search-all-mail-accounts =
::   .label = Search all mail accounts
::   .accesskey = m
%lecho% "search-all-mail-accounts ="                  >> localization\ru\messenger\messenger.ftl
%lecho% "  .label = Поиск по всем почтовым аккаунтам" >> localization\ru\messenger\messenger.ftl
%lecho% "  .accesskey = п"                            >> localization\ru\messenger\messenger.ftl
