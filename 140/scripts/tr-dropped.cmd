...
sed -i -e 's/^qr-export-pane-header\(.*\){ -brand-product-name }\(.*\)/qr-export-pane-header\1Thunderbird\2/' localization\tr\messenger\preferences\preferences.ftl
sed -i -e 's/^qr-export-get-app\(.*\){ -brand-product-name }\(.*\)/qr-export-get-app\1Thunderbird\2/' localization\tr\messenger\preferences\preferences.ftl

%lecho% "Expires=Expires" >> chrome\tr\locale\tr\messenger\search-attributes.properties
...
::    .accesskey = z
%lecho% "menu-view-layout-horizontal =" >> localization\tr\messenger\menubar.ftl
%lecho% "    .label = Yatay Görünüm"    >> localization\tr\messenger\menubar.ftl
%lecho% "    .accesskey = y"            >> localization\tr\messenger\menubar.ftl
...
%lecho% "<!ENTITY storeOnUpdated.label \"Güncellenen makaleleri kaydet\">" >> chrome\tr\locale\tr\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeOnUpdated.accesskey \"y\">"                         >> chrome\tr\locale\tr\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeOnUpdatedInfo.label \""'&lt;updated&gt;'" etiketi bulunan Atom veya JSON beslemeleri için. Yayıncı bu değeri değiştirirse, makale yinelenmiş olarak sayılmak yerine kaydedilir.\">" >> chrome\tr\locale\tr\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeWebPageArchive.label \"Makaleyle birlikte web sayfasının bir arşivini kaydet\">" >> chrome\tr\locale\tr\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeWebPageArchive.accesskey \"w\">" >> chrome\tr\locale\tr\messenger-newsblog\feed-subscriptions.dtd

:: Original strings:
:: run-filters-on-incoming-msgs =
::   .label = Run filters on incoming messages
%lecho% "run-filters-on-incoming-msgs ="                  >> localization\tr\messenger\folderprops.ftl
%lecho% "  .label = Gelen iletilerde filtreleri çalıştır" >> localization\tr\messenger\folderprops.ftl
...
%lecho% "carddav-directory-sync-warning =" >> localization\tr\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "    CardDAV: Bazı veriler sunucu tarafından silindi, ayrıntılar için Hata Konsolunu kontrol edin" >> localization\tr\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "carddav-directory-sync-failed =" >> localization\tr\messenger\addressbook\abCardDAVProperties.ftl
%lecho% "    CardDAV: Sunucuyla eşzamanlama başarısız oldu, ayrıntılar için Hata Konsolunu kontrol edin" >> localization\tr\messenger\addressbook\abCardDAVProperties.ftl
