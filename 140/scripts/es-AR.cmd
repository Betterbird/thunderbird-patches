...
%lecho% "<!ENTITY storeWebPageArchive.label \"Store an archive of the web page with the article\">" >> chrome\es-AR\locale\es-AR\messenger-newsblog\feed-subscriptions.dtd
