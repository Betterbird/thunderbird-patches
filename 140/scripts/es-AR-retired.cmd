...
::     .accesskey = R
%lecho% "mail-context-unthread-message ="                >> localization\es-AR\messenger\messenger.ftl
%lecho% "    .label = Quitar mensage de la conversación" >> localization\es-AR\messenger\messenger.ftl
%lecho% "    .accesskey = Q"                             >> localization\es-AR\messenger\messenger.ftl
%lecho% "mail-context-reset-message-threading ="         >> localization\es-AR\messenger\messenger.ftl
%lecho% "    .label = Restaurar conversación original"   >> localization\es-AR\messenger\messenger.ftl
%lecho% "    .accesskey = R"                             >> localization\es-AR\messenger\messenger.ftl
...
%lecho% "Expires=Expires" >> chrome\es-AR\locale\es-AR\messenger\search-attributes.properties
...
::    .accesskey = z
%lecho% "menu-view-layout-horizontal =" >> localization\es-AR\messenger\menubar.ftl
...
%lecho% "<!ENTITY storeOnUpdated.label \"Guardar artículos actualizados\">" >> chrome\es-AR\locale\es-AR\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeOnUpdated.accesskey \"u\">"                  >> chrome\es-AR\locale\es-AR\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeOnUpdatedInfo.label \"Para feeds Atom o JSON con el elemento "'&lt;updated&gt;'". Si el editor cambia el valor, el artículo se guarda en lugar de tratarse como un duplicado.\">" >> chrome\es-AR\locale\es-AR\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeWebPageArchive.label \"Guardar un archivo de la página web junto con el artículo\">" >> chrome\es-AR\locale\es-AR\messenger-newsblog\feed-subscriptions.dtd
%lecho% "<!ENTITY storeWebPageArchive.accesskey \"w\">" >> chrome\es-AR\locale\es-AR\messenger-newsblog\feed-subscriptions.dtd

:: Original strings:
:: run-filters-on-incoming-msgs =
::   .label = Run filters on incoming messages
%lecho% "run-filters-on-incoming-msgs ="                        >> localization\es-AR\messenger\folderprops.ftl
%lecho% "  .label = Ejecutar filtros en los mensajes entrantes" >> localization\es-AR\messenger\folderprops.ftl
